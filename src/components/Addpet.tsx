...
import { AddFormPet } from "@/data";
import { IAddPet } from "@/interface";
import { AddPetSchema } from "@/validation/Schema";
import { yupResolver } from "@hookform/resolvers/yup";
import { SubmitHandler, useForm } from "react-hook-form";
import InputError from "./InputError";
import { ChangeEvent, useState } from "react";
import { useAddNewPetMutation } from "@/redux/features/Pet/PetSlice";
interface IProps {
...
function Addpet({ userId }: IProps) {
  ...
  const onSubmit: SubmitHandler<IAddPet> = async (data) => {
    console.log(data);
    console.log(img);
    const formData = new FormData();
    formData.append("user_id", String(userId));
    formData.append("name", data.name);
    formData.append("vaccines", data.vaccines);
    if (img) {
