  ...
  return (
    <div className="flex items-center justify-between text-sm py-2 mb-5 border-b border-b-gray-400 ">
      ...
      <ul className="hidden md:flex justify-end  gap-5 font-medium flex-1">
        <NavLink to="/">
          <li className="py-1 text-lg px-2 ">HOME</li>
        ...
        <NavLink to={"/doctor"}>
          <li className="py-1 text-lg px-2 ">Doctor</li>
          <hr className="border-none outline-none h-0.5 bg-primary w-3/5 m-auto hidden" />
        </NavLink>
        <NavLink to={"/services"}>
          <li className="py-1 text-lg px-2 ">Services</li>
          <hr className="border-none outline-none h-0.5 bg-primary w-3/5 m-auto hidden" />
        </NavLink>
        <NavLink to={"/about"}>
          <li className="py-1 text-lg px-2 ">About</li>
          <hr className="border-none outline-none h-0.5 bg-primary w-3/5 m-auto hidden" />
        </NavLink>
        <NavLink to={"/profile"}>
          <li className="py-1 text-lg px-2 ">Profile</li>
          <hr className="border-none outline-none h-0.5 bg-primary w-3/5 m-auto hidden" />
        </NavLink>
      </ul>
